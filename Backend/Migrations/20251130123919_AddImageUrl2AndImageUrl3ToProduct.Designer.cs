...
namespace ModernIssues.Migrations
{
    ...
    [Migration("20251130123919_AddImageUrl2AndImageUrl3ToProduct")]
    partial class AddImageUrl2AndImageUrl3ToProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ModernIssues.Models.Entities.product", b =>
                {
                    ...
                    b.Property<string>("image_url_2")
                        .HasColumnType("text");

                    b.Property<string>("image_url_3")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ModernIssues.Models.Entities.user", b =>
                {
                    ...
                    b.Property<DateTime?>("two_factor_enabled_at")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("two_factor_method")
                        .HasColumnType("text");

                    b.Property<string>("two_factor_recovery_codes")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ModernIssues.Models.Entities.warranty_detail", b =>
                {
                    ...
                    b.Property<string>("history_json")
                        .HasColumnType("TEXT")
